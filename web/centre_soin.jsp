<%-- 
    Document   : centre_soin
    Created on : 10 avr. 2014, 01:12:44
    Author     : Dhekra_PC
--%>
<%-- 
   ok
    ...
    <body>
        <div id="bloc_page">
			...
			<!-- InstanceBeginEditable name="CheminNav" -->
                        <a href="Activite.jsp">Activités</a>  -&gt;Centre du soin<!-- InstanceEndEditable -->
		</ul>
                    </div> 
                <article>
                    <fieldset>
                        <p><h2> Centre du soin</h2></p><p><img src="images/dow.jpg" style=" width: 400px; height: 200px;" />-L’accueil doit être chaleureux et personnalisé permettant d’établir un climat de confiance réciproque.
                        </p>
                        <p>
-L’information doit être claire et intelligible, axée sur les règles principales du don et sur l’importance de la validité des réponses du donneur pour la sécurité transfusionnelle.
<br>
-L’identification du donneur en vue d’établir son dossier médico-administratif doit être précise.
                        </p>
                        <p>
                         Une soirée réussie, instructive et conviviale.

 Sensibilisation des jeunes à l’importance de donner son sang.

 Fidéliser les premiers donneurs qui ne sont pas revenus.

 Que la soirée ait un certain écho positif dans les groupes, les familles, les médias (présence des DNA à la soirée).

 Obtenir des promesses de don écrites en vue de la collecte qui aura lieu le lundi suivant (14 mars 2011) et que les jeunes se présentent à cette collecte.
