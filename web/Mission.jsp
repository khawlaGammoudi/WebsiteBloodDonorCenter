<%-- 
    Document   : Mission
    Created on : 6 avr. 2014, 21:26:06
    Author     : Dhekra_PC
--%>
<%-- 
   ok
    ...
    <body>
        <div id="bloc_page">
			...
			<!-- InstanceBeginEditable name="CheminNav" -->
                        <a href="Accueil.jsp">Accueil</a>-&gt;<a href="CRTS.jsp">CRTS</a>-&gt;<strong>Nos Missions</strong> <!-- InstanceEndEditable -->
                    </ul>
                   </div> 
                <article>
                    <fieldset>
                        <div>
                       LES VALEURS DE LA TRANSFUSION SANGUINE

                    En Tunisie, le don du sang est régi par les principes fondateurs de la transfusion sanguine 
                    (loi du 21 juillet 1952). ces principes fondateurs sont :
                    - L'anonymat : l'identité du donneur et du receveur de sang est seulement connue de le CRTS.
                    ...
                    - Le non-profit : le sang et les produits sanguins ne peuvent être sources de profit.</div>
                        <div>
                            Le CRTS défend et promeut, en En tunisie, un modèle éthique du don de sang.</div>
                      </fieldset>
