<%-- 
    Document   : OuDonner
    Created on : 6 avr. 2014, 23:13:49
    Author     : Dhekra_PC
--%>
<%-- 
   ok
            ...
            <section>
                <article>
                    <fieldset>
                        ...
                        <h1> OÙ DONNER</h1>
                        <div>
                        Le Centre du transfusion Sanguine accueille 
                        les donneurs de 
                        sang tout au long de l’année. Pour ce faire, il 
                        organise un peu plus 
                        de 40 000 collectes mobiles de don de sang par an.
                        </div>
                        <div>
                            Les sites fixes sont équipés de machines 
                        qui permettent d’effectuer un don de sang total,
                        un don de plasma ou
                        de plaquettes. En revanche, et contrairement au don
                        de sang, comme de 
                        gros appareils sont nécessaires, le don de plasma 
                        en collecte mobile 
                        n’est pas toujours possible. Un homme peut donner 
                        son sang jusqu’à 6 fois
                        par an, une femme 4. Pour savoir où et quand vous pourrez faire un don de 
                        sang, nous vous invitons à utiliser notre moteur de 
                        recherche de collecte en renseignant le code de 
                        votre département.</div>
                     </fieldset>
