    ...
    <body>
        <div id="bloc_page">
			...
			<!-- InstanceBeginEditable name="CheminNav" -->
                        <a href="Activite.jsp">Activités</a>  -&gt;Actualités<!-- InstanceEndEditable -->
		</ul>
                    </div> 
                <article>
                    <fieldset style="height:500px;">
                        <b><%out.println((new java.util.Date()).toString());%></b>
                        <br>
                        CRTS est pleinement associée 
                        aux activités médicales et 
                        techniques de l’établissement. 
                        Les activités de recherche se 
                        déclinent dans 20
                        laboratoires présents dans 5
                        établissements régionaux de CRTS. 
                        ...
                        (EPST) comme l’Inserm ou le CRTS. </fieldset>
