<%-- 
    ...
    Created on : 6 avr. 2014, 21:42:43
    Author     : Dhekra_PC
--%>
<%-- 
   ok
    ...
    <body>
        <div id="bloc_page">
			...
			<!-- InstanceBeginEditable name="CheminNav" -->
                        <a href="Accueil.jsp">Accueil</a>-&gt; <a href="CRTS.jsp">CRTS</a>-&gt;<strong>Documents thématique</strong> <!-- InstanceEndEditable -->
                    </ul>
                   </div> 
                <div class="xcontenu">
                        ...
                        <div style="color:blue; font-size: 16px;" >
                            <h3>Documents thématiques</h3></div>
                        
                        <div><h4>Le don éthique : un choix de société
                            </h4></div>
                                                								
                                                <div>En Tunisie,  le <span class="kwgx6m" id="kwgx6m_2">don de sang</span> 
                                                est bénévole, anonyme, volontaire et ne fait l’objet d’aucun profit. 
                                                ...
                                                <hr style="border: 2px #003D6B dotted;" >
                                                    <div style="color:blue; font-size: 16px;" ><h4> A quoi sert le plasma ? 
                                                        </h4></div>								
                                                    Indispensable et irremplaçable, le 
                                                    <span>plasma</span> 
                                                    est particulièrement riche en protéines. « Celles-ci sont vitales grâce à leurs propriétés uniques», indique le Professeur Alain Fischer, chef du service d’hématologie immunologie pédiatrique du CHU Necker-Université Paris-Descartes.
                                                <hr style="border: 2px #003D6B dotted;" >
                                                <div style="color:blue; font-size: 16px;" ><h4>
                                                    "Les protéines plasmatiques sont vitales"
                                                    </h4></div>
                                                ...
                                                <hr style="border: 2px #003D6B dotted;" >
                                                <h4>
                                                    "Les médicaments dérivés du plasma redonnent une seconde vie aux malades"
                                                </h4>
                                            <hr style="border: 2px #003D6B dotted;" >
                                                <div style="color:blue; font-size: 16px;" ><h4>
                                                        Glossaire 
                                                    ...
                                                    Don de sang total, don de plasma en aphérèse, fractionnement, médicaments dérivés du plasma, <span class="kwgx6m" id="kwgx6m_4">protéines plasmatiques</span>... retrouvez ici tous les termes permettant de comprendre l'univers médical du plasma.
                                                </div>
                ...
                <aside>
                   <p>
                       <input type="button" name="CRTS" value="CRTS" onClick="javascript:window.open('CRTS.jsp');">
                    </p>>
                    </p> 
                    <ul id="menu-accordeon">
                       <li><a href="Qui_somme_nous.jsp">Qui sommes nous?</a></li>
                        <li><a href="Histoire.jsp">Histoire</a></li>
                        <li><a href="Mission.jsp">Nos missions</a>
