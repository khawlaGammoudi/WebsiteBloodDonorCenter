  (function($){
 	...
 	/**
 52 	* init events
 53 	* @param {jQuery.fn.jplist.view.PanelControl} control
 54 	* @memberOf jQuery.fn.jplist.controls.AutocompleteRadius
	*/
 	...
 	/**
133 	* get current control status
134 	* @param {boolean} isDefault - if true, get default (initial) control status; else - get current control status
135 	* @param {jQuery.fn.jplist.view.PanelControl} control
36 	* @return {jQuery.fn.jplist.models.Status}
 	* @memberOf jQuery.fn.jplist.controls.AutocompleteRadius
 	*/
