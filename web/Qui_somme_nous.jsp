<%-- 
    Document   : Qui_somme_nous
    Created on : 9 avr. 2014, 00:18:42
    Author     : Dhekra_PC
--%>
<%-- 
   ok
    ...
    <body>
        <div id="bloc_page">
			...
			<!-- InstanceBeginEditable name="CheminNav" -->
                       <a href="Accueil.jsp">Accueil</a>-&gt;<a href="CRTS.jsp">CRTS</a>-&gt;<strong>Qui sommes nous?</strong> <!-- InstanceEndEditable -->
                    </ul>
                   </div> 
                <article>
                    <fieldset>
                        <img src="img/download.jpg" alt="logo CRTS"/>
                        <b>CRTS:Centre R&#233;gionale de trasfusion sanguine</b>
                        <br>
                        <ul >
                           <li>Centre R&#233;gionale de trasfusion sanguine Mohamed Sassi - M'torech</li>
                           <li>Gabes</li>
                           <li><strong class="tel">Tel.: +216 75 29 27 00 </strong></li>
                        </ul>
                        <img src="" alt="" />
                    </fieldset>
                ...
                <aside>
                      <p>
                    <input type="button" name="CRTS" value="CRTS" >
                    </p>
