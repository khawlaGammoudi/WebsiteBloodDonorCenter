<%-- 
    Document   : Composants 
    Created on : 9 avr. 2014, 13:42:27
    Author     : Dhekra_PC
--%>
<%-- 
   ok
    ...
    <body>
        <div id="bloc_page">
			...
			<!-- InstanceBeginEditable name="CheminNav" -->
                        <a href="Accueil.jsp">Accueil</a> -&gt;<strong>Composants</strong> <!-- InstanceEndEditable -->
                    </ul>
                   </div> 
                <article>
                    <fieldset>
...
Effets indésirables relèvent de la pharmacovigilance
                        ...
                        <p>
                            Produits Sanguins Labiles PSL<br>
                            Globules Rouges<br>>
                            Plaquettes<br>
                            Plasma Frais Congelé<br>

                            collectés, préparés et distribués par CRTS(centre regional du trabsfusion sanguine à GABES)<br>
                            incidents liés à l’administration des PSL relèvent de l’hémovigilance.<br>
